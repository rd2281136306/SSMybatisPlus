...
public class RSA {
     ...
     * @return PrivateKey
     */
    public static PrivateKey getPvkformPfx(String fileName, String strPassword)
            throws Exception {
        ...
        KeyStore ks = getKsformPfx(fileName, strPassword);
        String keyAlias = getAlsformPfx(fileName, strPassword);
     ...
     * @return KeyStore
     */
    public static KeyStore getKsformPfx(String fileName, String strPassword)
            throws Exception {
        InputStream fis = null;
        Security.addProvider(new  org.bouncycastle.jce.provider.BouncyCastleProvider());

        KeyStore ks = KeyStore.getInstance("PKCS12", "BC");
        fis = (InputStream) RSA.class.getResourceAsStream("/"+fileName);;
    ...
    public static PublicKey getPubKeyFromCRT(String crtFileName) throws Exception {
        InputStream is = RSA.class.getResourceAsStream("/"+crtFileName);
